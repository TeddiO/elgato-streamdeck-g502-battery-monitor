...
type LogLevelString = keyof typeof allowedLevels;

const raw = process.env.BATTERY_MONITOR_LOGLEVEL?.toLowerCase() ?? "";
const logLevel: LogLevelString = (raw in allowedLevels ? raw : "error") as LogLevelString;
